...
import TelehealthBookButton from "./TelehealthBookButton";
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative p-8">
                ...
                {service.urgent && <UrgentCallButton />}
                {service.telehealth && <TelehealthBookButton />}
              </div>
